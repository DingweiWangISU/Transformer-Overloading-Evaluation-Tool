...
# Identify columns corresponding to customers (assuming customer column names start with "customer")
...
Pen_Level_EV = int(total_customers * Pen_Level_EV_percentage / 100)
Pen_Level_HP = int(total_customers * Pen_Level_HP_percentage / 100)

# Ensure at least one customer is selected if the percentage is very small
Pen_Level_EV = max(Pen_Level_EV, 1)
Pen_Level_HP = max(Pen_Level_HP, 1)
