...
if __name__ == "__main__":
    ...
    parser.add_argument('--amidata', default='static/samples/AMI.xlsx', help='XLSX with a full year of hourly AMI data for all the customers (default: %(default)s)')
    parser.add_argument('--tcinfo', default='static/samples/TC.xlsx', help='XLSX with transformer specifications and transformer-customer connectivity (default: %(default)s)')
