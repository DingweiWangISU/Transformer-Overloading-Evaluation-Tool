...
def transform_raw_to_ami(raw_ami_data):
    raw_ami_data = raw_ami_data.rename(columns={raw_ami_data.columns[0]: 'Time'})
    transformed_data = raw_ami_data.copy()
...
if __name__ == "__main__":
    ...
    raw_ami_data = validate_raw_ami(raw_ami_data, valid_mtr_ids)

    power_factor = 0.9
    transformed_tc_data = transform_raw_tc_with_index_and_check(raw_tc_data, raw_ami_data, power_factor)
    transformed_ami_data = transform_raw_to_ami(raw_ami_data)
